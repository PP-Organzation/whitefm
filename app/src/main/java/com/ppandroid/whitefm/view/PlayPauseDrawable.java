...
*/
package com.ppandroid.whitefm.view;
...
public class PlayPauseDrawable extends Drawable {
  ...
  public PlayPauseDrawable(Context context) {
    ...
    mPauseBarWidth = res.getDimensionPixelSize(R.dimen.dp_48);
    mPauseBarHeight = res.getDimensionPixelSize(R.dimen.dp_144);
    mPauseBarDistance = res.getDimensionPixelSize(R.dimen.dp_40);
  }
